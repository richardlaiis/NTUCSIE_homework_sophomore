...
\end{align*}
And it's valid when $x\ge 0,y\ge 0,x+y\le 15$. (Otherwise, $f(x,y)=0$)
\subsection*{(b)}
...
\begin{figure}[H]
    \centering\includegraphics[width=0.6\linewidth]{multinomial_support_region.jpg}
\end{figure}
...
\begin{figure}[H]
    \centering\includegraphics[width=0.9\linewidth]{canvas.png}
